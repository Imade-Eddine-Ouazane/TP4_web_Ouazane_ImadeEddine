package ma.emsi.ouazane.tp4web.llm;
...
public class RagRoutage {
    ...
    void init() {
        ...
        ContentRetriever retrMirrlees2020SocialMedia = buildRetriever("Mirrlees2020SocialMedia.pdf", parser, embeddingModel);
        ...
        sources.put(retrMirrlees2020SocialMedia, "Articles sur la social media, Digital Age ");
