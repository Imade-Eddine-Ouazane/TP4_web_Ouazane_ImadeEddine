...
public class RagTavily {
    ...
    void init() {
        try {
            ...
            ContentRetriever retrCuisine = buildRetriever("Mirrlees2020SocialMedia.pdf", parser, embeddingModel);

            // ====================== Tavily ======================
            String tavilyKey = System.getenv("travly");
            if (tavilyKey == null || tavilyKey.isBlank()) {
                throw new IllegalStateException(" manquante !");
            }
